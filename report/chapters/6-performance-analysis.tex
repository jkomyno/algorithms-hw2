...
\begin{figure}[H]
    ...
    \caption{Closest Insertion runtime and accuracy}
...
\begin{figure}[H]
    ...
    \caption{HeldKarp vs MST2Approximation vs ClosestInsertion accuracy error scaling by nodes (from 0 to 52 nodes)}
...
\begin{figure}[H]
    ...
    \caption{HeldKarp vs MST2Approximation vs ClosestInsertion accuracy error scaling by nodes (y log scaled)}
